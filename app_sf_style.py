...
"""
快递查询网站 - 顺丰风格版本
Express Tracking Website - SF Style Version
"""
...
app = FastAPI(
    title="快递查询网站",
    description="Express Tracking Website - SF Style",
    version="3.0.0"
)
        ...
        <header class="header">
            <div class="nav-container">
                ...
                <div class="user-actions">
                    <a href="/admin/" class="login-btn">用户登录</a>
                    <a href="/admin/" class="register-btn">管理后台</a>
                </div>
            </div>
        </header>
        ...
        <div class="container">
            ...
            <div class="info">
                ...
                <ul>
                    ...
                    <li><strong>响应式设计:</strong> 支持电脑、手机、平板访问</li>
                </ul>
            </div>
        </div>
    </body>
